...
def eye_tracking(r_arm, r_hand, motionData_x, motionData_y, l_arm, l_hand):
    ...
    if status_speak_mode == 1 : # 안내모드 일 때 
        # print("r_arm : ", r_arm)
        m.set_motors(positions=[ 0, 0, r_arm, r_hand, motionData_x, motionData_y, 0, 0, 30, -1 ], movetime=MT)
        flag_action = 1
...
while True :
    ...
    if people != '0' and people != '':
        ...
        if flag_action == 1:
            ...
            # print("flag_action(1):", flag_action)
            r_arm += r_arm_p * r_arm_d
            r_arm_d += 0.09
            # print("r_arm_p(1):", r_arm_p)
            if r_arm > 75 :
                r_arm = 79
            ...
            # print("flag_action(2):", flag_action)
            r_arm -= r_arm_p * r_arm_d
            r_arm_d += 0.09
            # print("r_arm_p(2):", r_arm_p)
            if r_arm > -60 :
                r_arm -= r_arm_p
            if r_arm <= -60 : 
                repeat = 2
            ...
            # print("flag_action(3):", flag_action)
